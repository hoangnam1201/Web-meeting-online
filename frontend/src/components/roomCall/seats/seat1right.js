    ...
    <div {...rest}>
      <div className="inline-block h-24">
        <div className="relative">
          ...
          <div className="h-8 overflow-hidden rounded-xl absolute z-10 top-1/3 left-14 transform -translate-y-1/2 -translate-x-1/2 rotate-90">
          ...
          <div className="bg-red-300 w-16 h-16 rounded-full relative flex justify-center items-center" >
            <SeatAvatar user={user}  style={{zIndex:20}}/>
          </div>
